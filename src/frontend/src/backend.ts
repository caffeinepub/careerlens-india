...
export class Backend implements backendInterface {
    ...
    async getSubtypeDetail(arg0: string): Promise<Subtype> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubtypeDetail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSubtypesByType(arg0: string): Promise<Array<Subtype>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubtypesByType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTypesByCategory(arg0: string): Promise<Array<IndustryType>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTypesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchSubtypes(arg0: string): Promise<Array<Subtype>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchSubtypes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
